...
class SubagentManager:
    ...
    async def _announce_result(
        ...
        """
        Announce the subagent result to the main agent vis the message bus.
        """
...
"""
    ...
    def _build_subagent_prompt(self, task: str) -> str:
        """
        Buiild a focused system prompt for the subagent.
        """
        return f"""
# Subagent
